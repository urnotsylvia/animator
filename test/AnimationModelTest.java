  ...
  public void textSVGoOutputTest() {
    ...
    assertEquals(
        "<svg viewBox=\"100 10 20 9\" version=\"1.1\" "
            ...
            + "dur=\"300.0ms\" attributeName=\"cx\" from=\"15\" to=\"20\" fill=\"freeze\" />\n"
            + "\t</ellipse>\n"
            + "\n"
            + "\t<ellipse id=\"o2\" cx=\"15\" cy=\"40\" rx=\"5\" ry=\"10\" "
            + "fill=\"rgb(100,0,20)\" visibility=\"visible\" >\n"
            + "\t\t<animate attributeType=\"xml\" begin=\"100.0ms\" dur=\"300.0ms\" "
            + "attributeName=\"cx\" from=\"15\" to=\"20\" fill=\"freeze\" />\n"
            + "\t\t<animate attributeType=\"xml\" begin=\"400.0ms\" dur=\"500.0ms\" "
            + "attributeName=\"fill\" from=\"rgb(100,0,20)\" to=\"rgb(10,100,100)\" "
            + "fill=\"freeze\" />\n"
            + "\t</ellipse>\n"
            + "\n"
            + "</svg>",
